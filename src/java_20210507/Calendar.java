...
public class Calendar {
	...
	public static final int MONDAY = 1; //final은 모두 대문자
	...
	private int getCount(int year, int month, int day) {
		int totalCount = 365 * (year - 1) + (year - 1) / 4 // 2020년까지 윤년
				...
				+ (year - 1) / 400; // 2020년까지 400의 배수는 윤년
...
//첫번쨰
	public void print(int year, int month) {
		...
		// 탭만큼 띄어쓰기 해야한다. 예) 2021년 5얼 달력을 출력하기 위해서는
		// 2021년 5월 1일까지 총 날짜를 구해서 7로 나눈 나머지만큼 띄어쓰기하면된다.
