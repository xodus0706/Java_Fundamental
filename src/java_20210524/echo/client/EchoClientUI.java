...
public EchoClientUI(String id, String ip, int port) {
	...
	JScrollPane jsp = new JScrollPane(
			jta,
			JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, //세로는 필요하면 scrollbar 만들어라
			JScrollPane.HORIZONTAL_SCROLLBAR_NEVER); //가로는 절대 만들지 말아라
	//jta.setBackground(new Color(135,100,150)); //Red, Green, Blue 순서 
	/****************************************중앙끝*******************************************************/
	/****************************************하단시작********************************************/
...
public static void main(String[] args) {
	JFrame.setDefaultLookAndFeelDecorated(true); //decoration이 달라짐
	new EchoClientUI("둑", "192.168.0.73", 3000).connect();
}
